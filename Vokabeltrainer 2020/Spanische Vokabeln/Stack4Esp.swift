...
class Stack4Esp: UIViewController {
    ...
    // Variablen
       ...
       override func viewDidLoad() {
           ...
           showWelcome()
           anzahlKannIchNochNicht = fourOfFourStacksEsp.count
       ...
       func dictInArray(){
           keysStack.removeAll()
           for key in fourOfFourStacksEsp.keys{
               keysStack.append(key)
           }
           valStack.removeAll()
           for value in fourOfFourStacksEsp.values{
       ...
       func deleteVocabel(){
                   ...
                   fourOfFourStacksEsp.removeValue(forKey: vocDeutsch.text!)
       ...
       func passTo3Stack(){
           thirdOfFourStacksEsp[vocDeutsch.text!] = spanischesWortStack1To2
