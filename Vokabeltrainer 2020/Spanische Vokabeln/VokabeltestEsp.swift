...
class VokabeltestEsp: UIViewController {
    ...
    @IBOutlet weak var txtSpanischeUebersetzung: UITextField!
    ...
    @IBAction func btnEnde(_ sender: UIButton) {
        ...
        txtSpanischeUebersetzung.isHidden = true
    ...
    func buttonSichtbar(){ // Button am Anfang einblenen
        ...
        txtSpanischeUebersetzung.isHidden = false
    ...
    func nextRound(){ // kreiert die nächste Runde
        ...
        if runner < counter{
            actualVoc = randNumb[runner]
                   lblKeyWord.text = keysEsp[actualVoc]
                   rightAnswer = valuesEsp[actualVoc]
    ...
    func checkingTheAnswer(){ // Nach Eingabe Button klick Ant checken
        ...
        if txtSpanischeUebersetzung.text!.isEmpty{
            ...
            if txtSpanischeUebersetzung.text == rightAnswer{
                ...
                lblSkip.isHidden = true
                lblNext.isHidden = false
                dataForArray = ("\(txtSpanischeUebersetzung.text!) / \(rightAnswer) = \(lblKeyWord.text!)  |  ")
    ...
    func skip(){
        txtSpanischeUebersetzung.text = "Nicht Gewusst"
        checkingTheAnswer()
        animatedButtonSkip()
    }
    ...
    func fillInFalseWoerterbuch(){
        if woerterbuchWiederholenEsp[lblKeyWord.text!] != nil {
            
        }else{
            woerterbuchWiederholenEsp[lblKeyWord.text!] = rightAnswer  // Zuweisung
            UserDefaults.standard.set(woerterbuchWiederholenEsp, forKey: "gespWoerterbuchWiedEsp") // Speichern
        }
    }
