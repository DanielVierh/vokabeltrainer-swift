//
//  Stack1ViewControllerTrain.swift
//  Vokabeltrainer 2020
//
...
class Stack1ViewControllerTrain: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        lblBtnNichtgewusst.isHidden = true
        showWelcome()
        anzahlKannIchNochNicht = firstOfFourStacks.count
    ...
    func dictInArray(){
        keysStack.removeAll()
        for key in firstOfFourStacks.keys{
            keysStack.append(key)
        }
        valStack.removeAll()
        for value in firstOfFourStacks.values{
    ...
    func deleteVocabel(){
                ...
                firstOfFourStacks.removeValue(forKey: vocDeutsch.text!)
    ...
    func passTo2Stack(){
        secondOfFourStacks[vocDeutsch.text!] = englischesWortStack1To2
