//
//  Stack3ViewControllerTrain.swift
//  Vokabeltrainer 2020
//
...
class Stack3ViewControllerTrain: UIViewController {
    ...
    @IBAction func btn_Skip(_ sender: Any) {
       ...
       override func viewDidLoad() {
           ...
           showWelcome()
           anzahlKannIchNochNicht = thirdOfFourStacks.count
       ...
       func dictInArray(){
           keysStack.removeAll()
           for key in thirdOfFourStacks.keys{
               keysStack.append(key)
           }
           valStack.removeAll()
           for value in thirdOfFourStacks.values{
       ...
       func deleteVocabel(){
                   ...
                   thirdOfFourStacks.removeValue(forKey: vocDeutsch.text!)
       ...
       func passTo4Stack(){
           fourOfFourStacks[vocDeutsch.text!] = englischesWortStack
           UserDefaults.standard.set(fourOfFourStacks, forKey: "gespWoerterbuchFourStack") // Speichern
       }
           
       // --> An Stack 2 übergeben
       func passTo2Stack(){
           secondOfFourStacks[vocDeutsch.text!] = englischesWortStack
